...
def _get_user_agent() -> str:
    ...
    return f"AlibabaCloud-Agent-Skills/alibabacloud-bailian-memory/{session_id}"
...
def generate_api_key(description: str = "AI Agent auto-generated, for bailian-memory") -> Tuple[str, str]:
    """
