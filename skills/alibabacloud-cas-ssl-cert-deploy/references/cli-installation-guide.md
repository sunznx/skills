...
Download the installer, review it, then execute — works on both macOS and Linux, auto-detects architecture. Never pipe remote scripts directly into bash:
