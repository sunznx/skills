# RAM Policies for Bailian Video Creator
...
- If you only need video generation/understanding (not API Key management), no RAM permissions are required -- only a valid DASHSCOPE_API_KEY
