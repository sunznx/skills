...
def build_queries(
    *,
    ...
    # normalized_score_value is a DOUBLE column in SLS; comparing it to '' directly
    # fails with ParameterInvalid ("'<>' cannot be applied to double, varchar(0)").
    score_present = "normalized_score_value IS NOT NULL AND CAST(normalized_score_value AS varchar) != ''"
